...
function validaEmail() {
    //const regex = /[a-zA-Z0-9_]+@[a-zA-Z0-9_]+\.[a-zA-Z0-9_]+/; //pode ser usado assim, apontando os caracteres
    const regex = /\w+@\w+\.\w+/;//OU ASSIM DE FORMA MAIS LIMPA - o \w representa todos os caracteres
...
function validaSenha() {
    const regex = /^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[!#@%&]).{6,15}$/; //{6,15} entre 6 e 15
